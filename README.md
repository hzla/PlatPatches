...
| Nature Mints `Pokemon_CheckItemEffects` hook | `0x02096420-0x02096427` | `0x0009A420-0x0009A427` | `0x8` | Lets mint items pass or fail party-item eligibility without consuming on eggs, empty slots, or already-matching natures. |
...
| Bottle Caps `Pokemon_CheckItemEffects` hook | `0x02096420-0x02096427` | `0x0009A420-0x0009A427` | `0x8` | Chained with Nature Mints when both are installed; lets cap items fail without consuming on eggs, empty slots, or already-maxed IVs. |
